...
export class MovimientoData {
  ...
  load(cuentaId: number): any {
    if (this.data) {
      console.log("data no es null");
      return this.http.get('http://ec2-34-192-160-14.compute-1.amazonaws.com:10081/api/movimiento/listar?cuentaId=' + cuentaId)
  ...
  processData(data: any) {
    ...
    datos.forEach((movimiento: any) => {
      movimiento.fecha2 = '1994-12-15T13:47:20.789+5:00';
